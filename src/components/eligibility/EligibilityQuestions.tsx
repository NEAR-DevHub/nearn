          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className={cn('flex flex-col gap-2')}>
                <div>
                  <FormLabel isRequired>Link to Your Submission</FormLabel>
                  <FormDescription>
            ...
            render={({ field }) => (
              <FormItem className={cn('flex flex-col gap-2')}>
                <div>
                  ...
                  <FormDescription>
                    This helps sponsors discover (and maybe repost) your work on
                    Twitter! If this submission is for a Twitter thread bounty,
                        ...
                        >
                          ...
                          <SelectContent>
                            {e.variants?.map((variant, variantIndex) => (
                              <SelectItem key={variantIndex} value={variant}>
                                {variant}
                              </SelectItem>
                            ))}
                          </SelectContent>
