...
const Stat = ({ value, label }: StatProps) => {
  return (
    <div>
      ...
      <p className="text-xs font-medium text-brand-green md:text-sm">{label}</p>
    </div>
  );
};
...
export const UserStatsBanner = () => {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-md bg-gradient-to-r from-black to-black/80 px-6 py-6 text-white md:flex-row md:items-center md:justify-between md:px-8">
